...
public class ClientHttpRequestException extends RuntimeException{
     ...
     *                method.
     */
    public ClientHttpRequestException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public ClientHttpRequestException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public ClientHttpRequestException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    public ClientHttpRequestException(String message, Throwable cause, boolean enableSuppression,
